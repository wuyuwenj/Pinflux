  ...
  if(sessionUser){
    ...
    <div className="navBar" id='loggedInNav'>
      ...
      <div className='backNav'>
        <div className='icons'><button className="bellButton"><i class="fa-solid fa-bell"></i></button></div>
        <div className='icons'><button className="messageButton"><i class="fa-solid fa-comment-dots"></i></button></div>
        <div className='icons'><button className="userButton"><div className="name-text">{sessionUser.username[0]}</div></button></div>
